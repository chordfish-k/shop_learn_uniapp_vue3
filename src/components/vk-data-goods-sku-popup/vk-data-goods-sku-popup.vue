<template>
	<view class="vk-data-goods-sku-popup"
		  catchtouchmove="true"
		...
		<view class="layer attr-content"
			...
			<view class="specification-wrapper">
					...
					<view class="specification-header">
						...
						<view class="specification-right">
							<view class="price-content"
								...
								<text class="price"
									  :class="priceCom.length > 16 ? 'price2' : ''">{{ priceCom }}</text>
							</view>
							<view class="inventory"
								  v-if="!hideStock">{{ stockText }}：{{ stockCom }}</view>
							<view class="inventory"
								  v-else></view>
							<view class="choose"
								  v-show="isManyCom">已选：{{ selectArr.join(' ') }}</view>
						</view>
					</view>

					<view class="specification-content">
						<view v-show="isManyCom"
						...
						<view class="number-box-view">
							...
							<view style="flex: 4;text-align: right;">
								<vk-data-input-number-box v-model="selectNum"
														  :min="minBuyNum || 1"
														  :max="maxBuyNumCom"
														  :step="stepBuyNum || 1"
				...
				<view class="close"
					...
					<image class="close-item"
						   :src="closeImage"></image>
				</view>
			</view>
