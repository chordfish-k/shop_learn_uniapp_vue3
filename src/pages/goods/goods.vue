...
// 弹出层条件渲染
const popupName = ref<'addresss' | 'service'>()
...
const getMemberAddresData = async () => {
...
<template>
  ...
  <scroll-view scroll-y
    ...
    <view class="goods">
      ...
      <view class="action">
        ...
        <view class="item arrow"
              @tap="openPopup('addresss')">
          <text class="label">送至</text>
          <text class="text ellipsis"> {{ currentAddress?.fullLocation || '请选择收获地址' }} </text>
        </view>
        <view class="item arrow"
    ...
    <view class="similar panel">
      ...
      <view class="content">
        <navigator v-for="item in goods?.similarProducts"
                   :key="item.id"
                   class="goods"
                   hover-class="none"
  ...
  <uni-popup ref="popup"
    ...
    <AddressPanel v-if="popupName === 'addresss'"
                  @close="popup?.close()"
